...
public class Customer {
	...
	// Ändrade så att man tar in en double ist för en int
	// Lade också till en setter i accountsklassen för att kunna uppdatera balance
	...
	public void closeAccount(long pNr, int accountId) {
		...
		// Jag är inte helt 100 på funktionen nedan så jag gjorde om det till en
		// if-sats. För mig blir det tydligare.
		// Ändrade också metoden till void så man kan kalla på funktionen så den skriver
		// ut direkt.
